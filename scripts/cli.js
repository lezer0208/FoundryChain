...
const contractABI = require("../artifacts/contracts/Foundrychain.sol/Foundrychain.json").abi;

program
    .name("foundrychain-cli")
    .description("CLI tool for Foundrychain smart contract")
    .version("1.0.0");
