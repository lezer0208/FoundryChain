 ...
 * This file demonstrates how to integrate Foundrychain with a web frontend
 */

// For React/Vue/Angular applications
export class FoundrychainClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FoundrychainClient(provider, contractAddress);
